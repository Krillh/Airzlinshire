...
Most roots are bound morphemes, requiring a suffix to become a word. There are some roots that can be used as free morphemes, like /dyo/ (verb: to be), and /ti/ (preposition: with).