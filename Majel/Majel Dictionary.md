...
| R (root) form | noun def.           | verb def.                    | adj. def.             | other def   | order |
| ------------- | ------------------- | ---------------------------- | --------------------- | ----------- | ----- |
| pa            | quality             |                              |                       |             | 0     |
...
| nibo          |                     |                              |                       | yes         | 1     |
| nubo          |                     |                              |                       | no          | 1     |
| qigu          | outside             |                              | outer                 |             | 1     |
| qugu          | inside              |                              | inner                 |             | 1     |
| bufa          | knife               | to cut                       | cut                   |             | 1     |
| bebufa        | dull knife          | to separate; break up        |                       |             | 1     |
| bapa          | quality of help     |                              |                       |             | 1     |
| guqe          | wall of building    | to block                     | walled                |             | 1     |
| ruguqe        | hole; door          |                              |                       |             | 1     |
