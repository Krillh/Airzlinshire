...
In order to measure majik, there are a few [[Units of Measure]]. Some of the most common ones are the **gako**, which measures majik power; **diako**, which measures majik density; **seko**, which measures majik flow rate; **guko**, which measures majik capacity. There's also **gukako**, which measures majik capacity efficiency of a material.
