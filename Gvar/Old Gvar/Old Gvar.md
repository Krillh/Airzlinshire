...
## Compound Roots
People found that they could put 2 bound roots together to create a compound root with its own unique meaning. Though some compound roots formed by repeated prefix use on a small set of roots. In compound roots, the final non-suffix syllable always gets the emphasis. 