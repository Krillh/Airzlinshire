...
### Mixing Elements?
There are some sub-elements that can be created by mixing two (or rarely, more than two) elemnts. Some examples are death majik, which is a mix of life and dark majik. It's important to know that there is no _evil_ forms of majik. There are only different ones. In Airzlinshire, 
